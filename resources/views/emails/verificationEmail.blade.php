@component('mail::message')
    ...
    <p>Yooo! Thanks for registering an account with Basicschool!
    ...
    <hr>
    <p>
        Be careful not to share your important data with parties on behalf of Basicschool or whose security cannot be
        guaranteed.
    </p>
@endcomponent
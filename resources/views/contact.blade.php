                ...
                <div class="row g-4 g-md-5 mt-0 mt-lg-3">
                    ...
                    <div class="col-lg-4 offset-lg-2 mt-lg-0">
                        <div class="card card-body bg-primary shadow py-5 text-center h-100">
                            <!-- Title -->
                            <h5 class="text-white mb-3">Basicschool</h5>
                            <ul class="list-inline mb-0">
                                <!-- Address -->
                                <li class="list-item mb-3">
                                    <a href="#" class="text-white"> <i
                                            class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>Jl. Ciparay No. 20B,
                                ...
                                <li class="list-item mb-0">
                                    <a href="#" class="text-white"> <i
                                            class="far fa-fw fa-envelope me-2"></i>school@basicteknologi.co.id </a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="pt-0">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="mapouter">
                            <div class="gmap_canvas"><iframe width="1300" height="400" id="gmap_canvas"
                                    src="https://maps.google.com/maps?q=pt.%20basicteknologi&t=&z=17&ie=UTF8&iwloc=&output=embed"

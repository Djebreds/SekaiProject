								...
								<div class="tab-content pt-2" id="course-pills-tabContent">
									...
									<div class="tab-pane fade show active" id="course-pills-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
										...
										<p class="mb-3">If you wish to find out the skills that should be covered in a
											...
											then reading this blog will help. Before we delve into the advanced <strong><a href="#"
										...
										<ul class="list-group list-group-borderless mb-3">
											...
											<li class="list-group-item h6 fw-light d-flex mb-0"><i class="fas fa-check-circle text-success me-2"></i>What
												is Search engine
												optimization(SEO)</li>
											<li class="list-group-item h6 fw-light d-flex mb-0"><i
											...
											<li class="list-group-item h6 fw-light d-flex mb-0"><i class="fas fa-check-circle text-success me-2"></i>Why
												SEO</li>
											...
											<li class="list-group-item h6 fw-light d-flex mb-0"><i class="fas fa-check-circle text-success me-2"></i>SEO
												tips and tricks
											</li>
											<li class="list-group-item h6 fw-light d-flex mb-0"><i
									...
									<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
										...
										<div class="card mb-0 mb-md-4">
											<div class="row g-0 align-items-center">
												<div class="col-md-5">
													<!-- Image -->
													<img src="{{ asset('assets/images/instructor/01.jpg') }}" class="img-fluid rounded-3"
												...
												<div class="col-12 bg-light-input">
													<div class="choices" data-type="select-one" tabindex="0" role="combobox" aria-autocomplete="list"
														...
														<div class="choices__inner"><select id="inputState2" class="form-select js-choice choices__input"
																...
																<option value="★★★★★ (5/5)" data-custom-properties="[object Object]">★★★★★ (5/5)
																</option>
															</select>
														...
														<div class="choices__list choices__list--dropdown" aria-expanded="false"><input type="text"
															...
															<div class="choices__list" role="listbox">
																...
																<div id="choices--inputState2-item-choice-2"
																	...
																	data-id="2" data-value="★★★★☆ (4/5)" data-select-text="Press to select"
																	data-choice-selectable="">★★★★☆ (4/5)</div>
																<div id="choices--inputState2-item-choice-3"
																	class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice=""
																	data-id="3" data-value="★★★☆☆ (3/5)" data-select-text="Press to select"
																	data-choice-selectable="">★★★☆☆ (3/5)</div>
																<div id="choices--inputState2-item-choice-4"
																	class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice=""
																	data-id="4" data-value="★★☆☆☆ (2/5)" data-select-text="Press to select"
																	data-choice-selectable="">★★☆☆☆ (2/5)</div>
																<div id="choices--inputState2-item-choice-5"
																	class="choices__item choices__item--choice choices__item--selectable" role="option" data-choice=""
																	data-id="5" data-value="★☆☆☆☆ (1/5)" data-select-text="Press to select"
																...
																<div class="ms-2">
																	...
																	<div class="bg-light p-3 rounded">
																		<div class="d-flex justify-content-center">
																			<div class="me-2">
																				<h6 class="mb-1 lead fw-bold"> <a href="#!"> Frances Guerrero
																					</a></h6>
															...
															<div class="d-flex">
																...
																<div class="ms-2">
																	...
																	<div class="bg-light p-3 rounded">
																		<div class="d-flex justify-content-center">
																			<div class="me-2">
																				<h6 class="mb-1 lead fw-bold"> <a href="#!"> Louis Ferguson
																					</a></h6>
																				<p class="h6 mb-0">Removed demands expense
																					account in outward tedious do.
																					Particular way thoroughly unaffected
							...
							<div class="col-md-6 col-lg-12">
								...
								<div class="card shadow p-2 mb-4 z-index-9">
									<div class="overflow-hidden rounded-3">
										<img src="{{ asset('assets/images/courses/4by3/01.jpg') }}" class="card-img" alt="course image">
										<!-- Overlay -->
									...
									<div class="card-body px-3">
										...
										<div class="mt-3 d-sm-flex justify-content-sm-between">
											<a href="{{ route('course.detail.learning') }}" class="btn btn-outline-primary mb-0">Free trial</a>
							...
							<div class="col-md-6 col-lg-12">
								...
								<div class="card card-body shadow p-4 mb-4">
									...
									<div class="row gx-3 mb-3">
										<!-- Image -->
										<div class="col-4">
											<img class="rounded" src="{{ asset('assets/images/courses/4by3/21.jpg') }}" alt="">
										</div>
										<!-- Info -->
										<div class="col-8">
									...
									<div class="row gx-3">
										<!-- Image -->
										<div class="col-4">
											<img class="rounded" src="{{ asset('assets/images/courses/4by3/18.jpg') }}" alt="">
										</div>
										<!-- Info -->
										<div class="col-8">
						...
						<div class="tns-outer" id="tns1-ow">
									...
									<div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
											...
											<div class="card p-2 border">
												<div class="rounded-top overflow-hidden">
													<div class="card-overlay-hover">
														<img src="{{ asset('assets/images/courses/4by3/18.jpg') }}" class="card-img-top" alt="course image">
													</div>
													<!-- Hover element -->
												...
												<div class="card-body">
													...
													<div class="d-flex justify-content-between">
														...
														<div class="avatar avatar-sm">
															<img class="avatar-img rounded-circle" src="{{ asset('assets/images/avatar/07.jpg') }}"
																alt="avatar">
														</div>
													</div>
													<!-- Divider -->
										...
										<div class="pb-4 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
											<div class="card p-2 border">
												<div class="rounded-top overflow-hidden">
													<div class="card-overlay-hover">
														<img src="{{ asset('assets/images/courses/4by3/21.jpg') }}" class="card-img-top" alt="course image">
													</div>
													<!-- Hover element -->
													<div class="card-img-overlay">
														<div class="card-element-hover d-flex justify-content-end">
												...
												<div class="card-body">
													...
													<div class="d-flex justify-content-between">
														...
														<!-- Avatar -->
														<div class="avatar avatar-sm">
															<img class="avatar-img rounded-circle" src="{{ asset('assets/images/avatar/05.jpg') }}"
																alt="avatar">
														</div>
													</div>
													<!-- Divider -->
										...
										<div class="pb-4 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
											<div class="card p-2 border">
												<div class="rounded-top overflow-hidden">
													<div class="card-overlay-hover">
														<img src="{{ asset('assets/images/courses/4by3/20.jpg') }}" class="card-img-top" alt="course image">
													</div>
													<!-- Hover element -->
													<div class="card-img-overlay">
														<div class="card-element-hover d-flex justify-content-end">
												...
												<div class="card-body">
													...
													<div class="d-flex justify-content-between">
														...
														<!-- Avatar -->
														<div class="avatar avatar-sm">
															<img class="avatar-img rounded-circle" src="{{ asset('assets/images/avatar/02.jpg') }}"
																alt="avatar">
														</div>
													</div>
													<!-- Divider -->
										...
										<div class="pb-4 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
											<div class="card p-2 border">
												<div class="rounded-top overflow-hidden">
													<div class="card-overlay-hover">
														<img src="{{ asset('assets/images/courses/4by3/17.jpg') }}" class="card-img-top" alt="course image">
													</div>
													<!-- Hover element -->
													<div class="card-img-overlay">
														<div class="card-element-hover d-flex justify-content-end">
										...
										<!-- Card Item START -->
										<div class="pb-4 tns-item" id="tns1-item2" aria-hidden="true" tabindex="-1">
											<div class="card p-2 border">
												<div class="rounded-top overflow-hidden">
													<div class="card-overlay-hover">
							...
							<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button"
									data-controls="prev" tabindex="-1" aria-controls="tns1"><i
										class="fas fa-chevron-left"></i></button><button type="button" data-controls="next" tabindex="-1"
									aria-controls="tns1"><i class="fas fa-chevron-right"></i></button></div>
						</div>
					</div>
					<!-- Slider END -->
				</div>

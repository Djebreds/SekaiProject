...
@section('content')
    <main>
        ...
        <section class="pt-5 pb-0"
            style="background-image:url({{ URL::asset('assets/images/element/map.svg') }}); background-position: center left; background-size: cover;">
            <div class="container">
                <div class="row">
                            ...
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-item mb-3">
                                    <a href="#" class="text-white"> <i
                                            class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>Chicago HQ Estica Cop. Macomb,
                                        MI 48042 </a>
                                </li>
                                <!-- Phone number -->
                                <li class="list-item mb-3">

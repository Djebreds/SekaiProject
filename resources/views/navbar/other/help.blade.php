@extends('navbar.other.layouts.main')
@section('left-side')
    <!-- Right side START -->
    <div class="col-md-9">
        <!-- Guide content START -->
        ...
        <div id="item-2">
            <div class="card">
                ...
                <div class="card-body px-0">
                    <p>At Basicschool, accessible from https://school.basicteknolog.co.id/, one of our main priorities is
                    ...
                    <p>Basicschool follows a standard procedure of using log files. These files log visitors when they visit
                    ...
                    <p>Like any other website, Basicschool uses 'cookies'. These cookies are used to store information
                    ...
                    <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                        are used in their respective advertisements and links that appear on Basicschool, which are sent
                    ...
                    <p>Note that Basicschool has no access to or control over these cookies that are used by third-party
                        advertisers.</p>

                    <h5 class="mt-4">Third Party Privacy Policies</h5>

                    <p>Basicschool's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                    ...
                    <p>Basicschool does not knowingly collect any Personal Identifiable Information from children under the
                    ...
                    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                        with regards to the information that they shared and/or collect in Basicschool. This policy is not
    ...
    <div id="item-3">
        <div class="card">
            ...
            <div class="card-body px-0">
                ...
                <p>These terms and conditions outline the rules and regulations for the use of Basicschool's Website,
                ...
                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Basicschool if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <h5 class="mt-4"><strong>Cookies</strong></h5 class="mt-4">

                <p>We employ the use of cookies. By accessing Basicschool, you agreed to use cookies in agreement with
                ...
                <h5 class="mt-4"><strong>License</strong></h5 class="mt-4">

                <p>Unless otherwise stated, Basicschool and/or its licensors own the intellectual property rights for
                    all material on Basicschool. All intellectual property rights are reserved. You may access this from
                    Basicschool for your own personal use subjected to restrictions set in these terms and conditions.
                </p>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Basicschool does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of Basicschool,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views
                    and opinions. To the extent permitted by applicable laws, Basicschool shall not be liable for the
                ...
                <p>Basicschool reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant Basicschool a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of Basicschool; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Basicschool. Please include your name, your
                ...
                <p>No use of Basicschool's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>

                <h5 class="mt-4"><strong>iFrames</strong></h5 class="mt-4">
                ...
                <h5 class="mt-4"><strong>Content Liability</strong></h5 class="mt-4">
                ...
                <h5 class="mt-4"><strong>Reservation of Rights</strong></h5 class="mt-4">
                ...
                <h5 class="mt-4"><strong>Removal of links from our website</strong></h5 class="mt-4">
                ...
                <h5 class="mt-4"><strong>Disclaimer</strong></h5 class="mt-4">

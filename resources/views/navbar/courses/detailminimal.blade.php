                            ...
                            <div tabindex="0"
                                ...
                                <div class="plyr__controls"><button class="plyr__controls__item plyr__control" type="button"
                                    ...
                                    <div class="plyr__controls__item plyr__progress__container">
                                        <div class="plyr__progress"><input data-plyr="seek" type="range" min="0"
                                                ...
                                                aria-valuenow="0" id="plyr-seek-5995" aria-valuetext="00:00 of 00:13"
                                                style="--value:0%;"><progress class="plyr__progress__buffer" min="0"
                                                max="100" value="21.453737745098042" role="progressbar"
                                    ...
                                    <div class="plyr__controls__item plyr__volume"><button type="button"
                                            ...
                                            aria-valuemin="0" aria-valuemax="100" aria-valuenow="100" id="plyr-volume-5995"
                                    ...
                                    <div class="plyr__controls__item plyr__menu"><button aria-haspopup="true"
                                            aria-controls="plyr-settings-5995" aria-expanded="false" type="button"
                                        ...
                                        <div class="plyr__menu__container" id="plyr-settings-5995" hidden="">
                                            <div>
                                                <div id="plyr-settings-5995-home">
                                                ...
                                                <div id="plyr-settings-5995-captions" hidden=""><button
                                                ...
                                                <div id="plyr-settings-5995-quality" hidden=""><button
                                                        type="button" class="plyr__control plyr__control--back"><span
                                                ...
                                                <div id="plyr-settings-5995-speed" hidden=""><button type="button"
                                ...
                                <div class="plyr__video-wrapper"><video crossorigin="anonymous" playsinline=""
                                    ...
                                    <div class="plyr__poster"
                                        style="background-image: url(&quot;{{ URL::asset('assets/images/videos/poster.jpg') }}&quot;);">
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane fade" id="course-pills-3" role="tabpanel"
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mt-2 mb-0">Person she control of to beginnings view looked eyes Than
                                                ...
                                                we've area wasn't everything.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Lose john poor same it case do year we Full how way even the
                                                ...
                                                though or Bachelor possible Marianne directly confined relation.</p>
                                        </div>
                                            ...
                                            <div class="accordion accordion-icon accordion-bg-light"
                                                ...
                                                <div class="accordion-item mb-3">
                                                    <h6 class="accordion-header font-base" id="heading-5">
                                                        <a class="accordion-button fw-bold collapsed rounded d-block"
                                                            ...
                                                            <span class="mb-0">What is Search Engine
                                                ...
                                                <div class="accordion-item mb-3">
                                                    <h6 class="accordion-header font-base" id="heading-8">
                                                        <a class="accordion-button fw-bold collapsed rounded d-block"
                                                            href="#collapse-8" data-bs-toggle="collapse"

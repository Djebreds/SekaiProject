                    ...
                    <div class="col-12">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 px-md-5 text-center position-relative order-md-2 mb-5 mb-md-0">
                                ...
                                <p class="mb-3">Grow your skill with the most reliable online courses and certifications
                                </p>
            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            class="card card-body bg-success bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            class="card card-body bg-orange bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/online.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            class="card card-body bg-danger bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/engineering.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            class="card card-body bg-purple bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/coding.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div class="card card-body bg-info bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/profit.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div class="card card-body bg-blue bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/medical.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            class="card card-body bg-warning bg-opacity-15 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/home.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div class="card card-body bg-dark bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/artist.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            ...
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/photography.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            ...
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/music.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            ...
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/marketing.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                    ...
                    <div class="col-sm-6 col-md-4 col-xl-3">
                        <div
                            class="card card-body bg-primary bg-opacity-10 text-center position-relative btn-transition p-4">
                            <!-- Image -->
                            <div class="icon-xl bg-body mx-auto rounded-circle mb-3">
                                <img src="{{ asset('assets/images/element/account.svg') }}" alt="">
                            </div>
                            <!-- Title -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            ...
                            <img src="{{ asset('assets/images/flags/fr.svg') }}" class="me-3 h-40px" alt="">
                            <h5 class="mb-0"><a href="#" class="stretched-link text-primary-hover"></a>French
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                            <img src="{{ asset('assets/images/flags/gr.svg') }}" class="me-3 h-40px" alt="">
                            <h5 class="mb-0"><a href="#" class="stretched-link text-primary-hover"></a>German
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                            <img src="{{ asset('assets/images/flags/sp.svg') }}" class="me-3 h-40px" alt="">
                            <h5 class="mb-0"><a href="#" class="stretched-link text-primary-hover"></a>Español
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                            <img src="{{ asset('assets/images/flags/uk.svg') }}" class="me-3 h-40px" alt="">
                            <h5 class="mb-0"><a href="#" class="stretched-link text-primary-hover"></a>English
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                            <img src="{{ asset('assets/images/flags/in.svg') }}" class="me-3 h-40px" alt="">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                            <img src="{{ asset('assets/images/flags/it.svg') }}" class="me-3 h-40px" alt="">
                            <h5 class="mb-0"><a href="#" class="stretched-link text-primary-hover"></a>Italian
                            </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div
                            class="bg-light rounded-2 p-3 d-flex align-items-center position-relative justify-content-center">
                            <img src="{{ asset('assets/images/flags/ar.svg') }}" class="me-3 h-40px" alt="">
                            <h5 class="mb-0"><a href="#" class="stretched-link text-primary-hover"></a>Arabic
                            </h5>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6 position-relative overflow-hidden">
                        <div class="bg-primary bg-opacity-10 rounded-3 p-5 h-100">
                            ...
                            <div class="position-absolute bottom-0 end-0 me-3">
                                <img src="{{ asset('assets/images/element/08.svg') }}" class="h-100px h-sm-200px"
                                    alt="">
                            </div>
                            <!-- Content -->
                            <div class="row">
                    ...
                    <div class="col-lg-6 position-relative overflow-hidden">
                        <div class="bg-secondary rounded-3 bg-opacity-10 p-5 h-100">
                            <!-- Image -->
                            <div class="position-absolute bottom-0 end-0 me-3">
                                <img src="{{ asset('assets/images/element/15.svg') }}" class="h-100px h-sm-200px"
                                    alt="">
                            </div>
                            <!-- Content -->
                            <div class="row">

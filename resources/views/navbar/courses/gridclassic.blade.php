                                ...
                                <form class="border rounded p-2 input-borderless">
                                    <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                        ...
                                        <div class="choices__inner"><select
                                                ...
                                                data-choice="active">
                                                <option value="" data-custom-properties="[object Object]">Most Viewed
                                                </option>
                                            </select>
                                            <div class="choices__list choices__list--single">
                                                <div class="choices__item choices__placeholder choices__item--selectable"
                                                    data-item="" data-id="1" data-value=""
                                                    data-custom-properties="[object Object]" aria-selected="true">Most
                                                    Viewed</div>
                                            </div>
                                        </div>
                                        <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                                ...
                                                aria-autocomplete="list" aria-label="Most Viewed" placeholder="">
                                            <div class="choices__list" role="listbox">
                                                <div id="choices--04t5-item-choice-2"
                                                    ...
                                                    aria-selected="true">Most Viewed</div>
                                                <div id="choices--04t5-item-choice-1"
                                                    ...
                                                    popular</div>
                                                <div id="choices--04t5-item-choice-3"
                                                    class="choices__item choices__item--choice choices__item--selectable"
                                                    role="option" data-choice="" data-id="3"
                                                    data-value="Recently search" data-select-text="Press to select"
                                                    data-choice-selectable="">Recently search</div>
                                                <div id="choices--04t5-item-choice-4"
                                                    class="choices__item choices__item--choice choices__item--selectable"

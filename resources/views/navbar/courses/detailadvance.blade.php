                            ...
                            <div class="col-12">
                                ...
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i
                                            class="fas fa-star me-2"></i>4.5/5.0</li>
                                    <li class="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i
                                            class="fas fa-user-graduate me-2"></i>12k Enrolled</li>
                                    <li class="list-inline-item fw-light h6 me-3 mb-1 mb-sm-0"><i
                                ...
                                <div class="video-player rounded-3">
                                    <div tabindex="0"
                                        ...
                                        <div class="plyr__controls"><button class="plyr__controls__item plyr__control"
                                            ...
                                            <div class="plyr__controls__item plyr__progress__container">
                                                <div class="plyr__progress"><input data-plyr="seek" type="range"
                                                        ...
                                                        aria-valuemin="0" aria-valuemax="13.056" aria-valuenow="0"
                                                        id="plyr-seek-8676" aria-valuetext="00:00 of 00:13"
                                                        style="--value:0%;"><progress class="plyr__progress__buffer"
                                                        min="0" max="100" value="21.415441176470587"
                                            ...
                                            <div class="plyr__controls__item plyr__time--current plyr__time"
                                                aria-label="Current time">-00:13</div>
                                            <div class="plyr__controls__item plyr__volume"><button type="button"
                                                    ...
                                                    aria-valuenow="100" id="plyr-volume-8676" aria-valuetext="100.0%"
                                            ...
                                            <div class="plyr__controls__item plyr__menu"><button aria-haspopup="true"
                                                    aria-controls="plyr-settings-8676" aria-expanded="false"
                                                ...
                                                <div class="plyr__menu__container" id="plyr-settings-8676"
                                                    hidden="">
                                                    <div>
                                                        <div id="plyr-settings-8676-home">
                                                        ...
                                                        <div id="plyr-settings-8676-captions" hidden=""><button
                                                                type="button"
                                                            ...
                                                            <div role="menu"><button data-plyr="language"
                                                                    ...
                                                                    data-plyr="language" type="button"
                                                                    role="menuitemradio" class="plyr__control"
                                                                    aria-checked="false" value="1"><span>French<span
                                                                            class="plyr__menu__value"><span
                                                                                class="plyr__badge">FR</span></span></span></button>
                                                            </div>
                                                        </div>
                                                        <div id="plyr-settings-8676-quality" hidden=""><button
                                                                type="button"
                                                                class="plyr__control plyr__control--back"><span
                                                            ...
                                                            <div role="menu"><button data-plyr="quality"
                                                                    ...
                                                                    role="menuitemradio" class="plyr__control"
                                                                    aria-checked="true" value="720"><span>720p<span
                                                                            class="plyr__menu__value"><span
                                                                                class="plyr__badge">HD</span></span></span></button><button
                                                                    data-plyr="quality" type="button"
                                                                    role="menuitemradio" class="plyr__control"
                                                        ...
                                                        <div id="plyr-settings-8676-speed" hidden=""><button
                                                                type="button"
                                                                class="plyr__control plyr__control--back"><span
                                        ...
                                        <div class="plyr__video-wrapper"><video crossorigin="anonymous" playsinline=""
                                                ...
                                                <source src="{{ asset('assets/images/videos/360p.mp4') }}"
                                                    type="video/mp4" size="360">
                                                <source src="{{ asset('assets/images/videos/720p.mp4') }}"
                                                    type="video/mp4" size="720">
                                                <source src="{{ asset('assets/images/videos/1080p.mp4') }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="collapse" id="collapseContent">
                                            ...
                                            <p class="mb-0">Behavioral psychology and influence triggers which are
                                                ...
                                                alone isn’t going to get the job done so that’s why this course is packed
                                ...
                                <div class="card border rounded-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-5">
                                            ...
                                            <div class="col-12">
                                                <!-- Curriculum item -->
                                                <h5 class="mb-4">What is Search Engine Optimization(SEO) (5 lectures)
                                                </h5>
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    <div class="d-flex">
                                                        <a href="#"
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="#"
                                                            class="btn btn-danger-soft btn-round mb-0 flex-shrink-0"><i
                                                                class="fas fa-play"></i></a>
                                                        <div class="ms-2 ms-sm-3 mt-1 mt-sm-0">
                                                            <h6 class="mb-0">How to Write Title Tags Search Engines Love
                                                            </h6>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">Preference any astonished unreserved Mrs. Prosperous
                                                ...
                                                resolving breakfast am or perfectly. It drew a hill from me. Valley by oh
                                                twenty direct me so. Departure defective arranging rapturous did believe him
                                                all had supported. Family months lasted simple set nature vulgar him.
                                                Picture for attempt joy excited ten carried manners talking how. Suspicion
                                                neglected the resolving agreement perceived at an. Comfort reached gay
                                                perhaps chamber his six detract besides add.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Meant balls it if up doubt small purse. Required his you put
                                                ...
                                                All led out world this music while asked. Paid mind even sons does he door
                                                no. Attended overcame repeated it is perceived Marianne in. I think on style
                                            ...
                                            <p class="mt-2 mb-0">Person she control of to beginnings view looked eyes Than
                                                continues its and because and given and shown creating curiously to more in
                                                are man were smaller by we instead the these sighed Avoid in the sufficient
                                                me real man longer of his how her for countries to brains warned notch
                                                important Finds be to the of on the increased explain noise of power deep
                                                asking contribution this live of suppliers goals bit separated poured sort
                                                several the was organization the if relations go work after mechanic But
                                                we've area wasn't everything needs of and doctor where would a of</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Two before narrow not relied how except moment myself
                                                Dejection assurance mrs led certainly So gate at no only none open Betrayed
                                                at properly it of graceful on Dinner abroad am depart ye turned hearts as me
                                                wished Therefore allowance too perfectly gentleman supposing man his now
                                                Families goodness all eat out bed steepest servants Explained the incommode
                                                sir improving northward immediate eat Man denoting received you sex possible
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Started several mistake joy say painful removed reached end.
                                                State burst think end are its. Arrived off she elderly beloved him affixed
                                                noisier yet. Course regard to up he hardly. View four has said do men saw
                                                find dear shy. Talent men wicket add garden. </p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Lose john poor same it case do year we Full how way even the
                                                sigh Extremely nor furniture fat questions now provision incommode preserved
                                                Our side fail to find like now Discovered traveling for insensible
                                                partiality unpleasing impossible she Sudden up my excuse to suffer ladies
                                                though or Bachelor possible Marianne directly confined relation as on he
                                            </p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <p class="mb-0">Preference any astonished unreserved Mrs. Prosperous
                                                understood Middletons in conviction an uncommonly do. Supposing so be
                                                resolving breakfast am or perfectly. Is drew am hill from me. Valley by oh
                                                twenty direct me so. Departure defective arranging rapturous did believe him
                                                all had supported. Family months lasted simple set nature vulgar him.
                                                Suspicion neglected he resolving agreement perceived at an. Comfort reached
                                                gay perhaps chamber his six detract besides add.</p>
                                        </div>
                                    </div>
                                    <!-- Card body START -->
                                </div>

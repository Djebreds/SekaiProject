...
@section('content')
    <main>
        ...
        <section class="bg-dark align-items-center d-flex"
            style="background:url({{ URL::asset('assets/images/pattern/04.png') }}) no-repeat center center; background-size:cover;">
                        ...
                        <div class="row g-3 align-items-center justify-content-md-end me-auto">
                            ...
                            <div class="col-sm-4 col-xl-6 text-md-end d-none d-md-block">
                                <ul class="list-inline mb-0">
                                    <!-- Grid icon -->
                                    <li class="list-inline-item"><a href="course-grid.html"
                                            class="btn btn-outline-light mb-0 me-2"><i
                                                class="fas fa-fw fa-th-large"></i></a></li>
                                    <!-- list icon -->
                                    <li class="list-inline-item"><a href="course-list.html"
                                            class="btn btn-outline-light mb-0 me-2"><i class="fas fa-fw fa-list-ul"></i></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <form class="col-md-4 border rounded p-1 input-borderless">
                                <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                    ...
                                    <div class="choices__inner"><select
                                            class="form-select js-choice z-index-9 choices__input"
                                    ...
                                    <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                        ...
                                        <div class="choices__list" role="listbox">
                                            <div id="choices--pim4-item-choice-5"
                                            ...
                                            <div id="choices--pim4-item-choice-1"
                                            ...
                                            <div id="choices--pim4-item-choice-2"
                                                class="choices__item choices__item--choice choices__item--selectable"
                                            ...
                                            <div id="choices--pim4-item-choice-3"
                                                class="choices__item choices__item--choice choices__item--selectable"
                                                role="option" data-choice="" data-id="3" data-value="Most Viewed"
                                                data-select-text="Press to select" data-choice-selectable="">Most Viewed
                                            </div>
                                            <div id="choices--pim4-item-choice-4"
                                                class="choices__item choices__item--choice choices__item--selectable"
                        ...
                        <div class="row g-4">
                                ...
                                <div class="card shadow overflow-hidden p-2">
                                    <div class="row g-0">
                                        <div class="col-md-5 overflow-hidden">
                                            <img src="{{ asset('assets/images/courses/4by3/06.jpg') }}" class="rounded-2"
                                                alt="Card image">
                                            <!-- Ribbon -->
                                        ...
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <!-- Badge -->
                                                    <a href="#"
                                                        class="badge bg-primary text-white mb-2 mb-sm-0">Development</a>
                                                    <!-- Rating and wishlist -->
                                                    <div>
                                                ...
                                                <!-- Title -->
                                                <h5 class="card-title"><a href="#">Angular – The Complete Guider</a>
                                                </h5>
                                                <p class="text-truncate-2 d-none d-lg-block">Satisfied conveying a
                                                    dependent contented he gentleman agreeable do be. dependent contented he
                                                </p>

                                                <!-- Info -->
                                                <ul class="list-inline">
                                                    <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                            class="far fa-clock text-danger me-2"></i>21h 56m</li>
                                                    <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                            class="fas fa-table text-orange me-2"></i>52 lectures</li>
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <p class="mb-0 ms-2"><a href="#"
                                                                class="h6 fw-light">Jacqueline Miller</a></p>
                                                    </div>
                                                    <!-- Price -->
                            ...
                            <div class="col-12">
                                <div class="card shadow p-2">
                                    <div class="row g-0">
                                        <div class="col-md-5">
                                            <img src="{{ asset('assets/images/courses/4by3/01.jpg') }}" class="rounded-2"
                                                alt="Card image">
                                        </div>
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <!-- Badge -->
                                                    <a href="#"
                                                        class="badge bg-primary text-white mb-2 mb-sm-0">Marketing</a>
                                                    <!-- Rating and wishlist -->
                                                    <div>
                                                        <span class="h6 fw-light me-3"><i
                                                                class="fas fa-star text-warning me-1"></i>4.5</span>
                                                ...
                                                <p class="text-truncate">Explained propriety off out perpetual his you.
                                                    Dependent contented he explained propriety off out perpetual his you.
                                                </p>
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <p class="mb-0 ms-2"><a href="#" class="h6 fw-light">Larry
                                                                Lawson</a></p>
                                                    </div>
                                                    <!-- Price -->
                                                    <div class="mt-3 mt-sm-0">
                            ...
                            <div class="col-12">
                                <div class="card shadow p-2">
                                    <div class="row g-0">
                                        <div class="col-md-5">
                                            <img src="{{ asset('assets/images/courses/4by3/11.jpg') }}" class="rounded-2"
                                                alt="Card image">
                                        </div>
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <div>
                                                        <span class="h6 fw-light me-3"><i
                                                                class="fas fa-star text-warning me-1"></i>4.8</span>
                                                        <a href="#" class="h6 fw-light"><i
                                                                class="far fa-heart"></i></a>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- Title -->
                                                <h5 class="card-title"><a href="#">The Ultimate Copywriting Course -
                                                        Write Copy That Sells</a></h5>
                                                <p class="text-truncate">Insipidity the sufficient discretion imprudence
                                                    resolution sir him decisively. Proceed how any engaged visitor.</p>

                                                <!-- Info -->
                                                <ul class="list-inline">
                                                    <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                            class="far fa-clock text-danger me-2"></i>15h 30m</li>
                                                    <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                            class="fas fa-table text-orange me-2"></i>72 lectures</li>
                                                    <li class="list-inline-item h6 fw-light"><i
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <p class="mb-0 ms-2"><a href="#" class="h6 fw-light">Louis
                                                                Crawford</a></p>
                                                    </div>
                                                    <!-- Price -->
                                                    <div class="mt-3 mt-sm-0">
                            ...
                            <div class="col-12">
                                <div class="card shadow p-2">
                                    <div class="row g-0">
                                        <div class="col-md-5">
                                            <img src="{{ asset('assets/images/courses/4by3/03.jpg') }}" class="rounded-2"
                                                alt="Card image">
                                        </div>
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <!-- Badge -->
                                                    <a href="#"
                                                        class="badge bg-primary text-white mb-2 mb-sm-0">Design</a>
                                                    <!-- Rating and wishlist -->
                                                    <div>
                                                        <span class="h6 fw-light me-3"><i
                                                                class="fas fa-star text-warning me-1"></i>4.0</span>
                                                        <a href="#" class="h6 fw-light"><i
                                                                class="far fa-heart"></i></a>
                                                    </div>
                                                </div>
                                                ...
                                                <!-- Title -->
                                                <h5 class="card-title"><a href="#">Create a Design System in
                                                        Figma</a></h5>
                                                <p class="text-truncate-2">Fulfilled direction use continual set him
                                                    propriety continued. Saw met applauded favorite deficient engrossed
                                                    concealed and her. Concluded boy perpetual old supposing.</p>

                                                <!-- Info -->
                                                <ul class="list-inline">
                                                    <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                            class="far fa-clock text-danger me-2"></i>7h 50m</li>
                                                    <li class="list-inline-item h6 fw-light mb-1 mb-sm-0"><i
                                                ...
                                                <div class="d-sm-flex justify-content-sm-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <p class="mb-0 ms-2"><a href="#"
                                                                class="h6 fw-light">Frances Guerrero</a></p>
                                                    </div>
                                                    <!-- Price -->
                                                    <div class="mt-3 mt-sm-0">
                                                        <a href="#" class="btn btn-dark">View more</a>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="flexCheckDefault9">All</label>
                                                    </div>
                                                    <!-- Checkbox -->
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="flexCheckDefault11">Design</label>
                                                    </div>
                                                    <!-- Checkbox -->
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label"
                                                            for="flexCheckDefault13">Finance</label>
                                                    </div>
                                                    <!-- Checkbox -->
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                                        ...
                                                        <label class="form-check-label"
                                                            for="flexCheckDefault14">Legal</label>
                                                    </div>
                                                    <!-- Checkbox -->
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value=""
                                        ...
                                        <div class="card card-body shadow p-4 mb-4">
                                            ...
                                            <ul class="list-inline mb-0 g-3">
                                                ...
                                                <li class="list-inline-item mb-2">
                                                    ...
                                                    <label class="btn btn-light btn-primary-soft-check"
                                                        for="btn-check-7">Bengali</label>
                                                </li>
                                                <!-- Item -->
                                                <li class="list-inline-item mb-2">
                                                    <input type="checkbox" class="btn-check" id="btn-check-8">
                                                    <label class="btn btn-light btn-primary-soft-check"
                                                        for="btn-check-8">Portuguese</label>
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- Language END -->

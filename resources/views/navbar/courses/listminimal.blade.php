                            ...
                            <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                ...
                                <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                    ...
                                    <div class="choices__list" role="listbox">
                                        <div id="choices--rsgc-item-choice-3"
                                        ...
                                        <div id="choices--rsgc-item-choice-1"
                                        ...
                                        <div id="choices--rsgc-item-choice-9"
                                            class="choices__item choices__item--choice choices__item--selectable"
                                        ...
                                        <div id="choices--rsgc-item-choice-10"
                                            class="choices__item choices__item--choice choices__item--selectable"
                                        ...
                                        <div id="choices--rsgc-item-choice-11"
                                            class="choices__item choices__item--choice choices__item--selectable"
                            ...
                            <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                ...
                                <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                    ...
                                    <div class="choices__list" role="listbox">
                                        ...
                                        <div id="choices--qi2t-item-choice-3"
                                            class="choices__item choices__item--choice choices__item--selectable"
                                            role="option" data-choice="" data-id="3" data-value="Popular"
                                            data-select-text="Press to select" data-choice-selectable="">Popular</div>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/01.jpg') }}" alt="card image">
                                </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/02.jpg') }}" alt="card image">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <!-- Title -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <h5 class="card-title mb-0"><a href="#">Graphic Design Masterclass</a>
                                            </h5>
                                            <!-- Wishlist icon -->
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/03.jpg') }}" alt="card image">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <!-- Title -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <h5 class="card-title mb-0"><a href="#">Create a Design System in
                                                    Figma</a></h5>
                                            <!-- Wishlist icon -->
                                            <a href="#" class="h6 fw-light"><i class="far fa-heart"></i></a>
                                        </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/05.jpg') }}" alt="card image">
                                </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/06.jpg') }}" alt="card image">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <!-- Title -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <h5 class="card-title mb-0"><a href="#">Angular – The Complete
                                                    Guider</a></h5>
                                            <!-- Wishlist icon -->
                                            <a href="#" class="h6 fw-light"><i class="far fa-heart"></i></a>
                                        </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/07.jpg') }}" alt="card image">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <!-- Title -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <h5 class="card-title mb-0"><a href="#">Deep Learning with
                                                    React-Native</a></h5>
                                            <!-- Wishlist icon -->
                                            <a href="#" class="h6 fw-light"><i class="far fa-heart"></i></a>
                                        </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/09.jpg') }}" alt="card image">
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <!-- Title -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <h5 class="card-title mb-0"><a href="#">JavaScript: Full
                                                    Understanding</a></h5>
                                            <!-- Wishlist icon -->
                                            <a href="#"><i class="fas fa-heart text-danger"></i></a>
                                        </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/11.jpg') }}" alt="card image">
                                </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/12.jpg') }}" alt="card image">
                                </div>
                    ...
                    <div class="col-lg-10 col-xxl-6">
                        <div class="card rounded overflow-hidden shadow">
                            <div class="row g-0">
                                <!-- Image -->
                                <div class="col-md-4">
                                    <img src="{{ asset('assets/images/courses/4by3/13.jpg') }}" alt="card image">
                                </div>

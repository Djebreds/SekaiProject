			...
			<div class="container">
				...
				<div class="row align-items-center g-5">
					...
					<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
						...
						<!-- Content -->
						<p class="my-4 lead">Basicschool is an educational program, we are aware of the skill gap between academics and
						...
						<div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start mb-5">
							<!-- Button -->
							<a href="{{ route('courses') }}" class="btn btn-lg btn-info me-2 mb-4 mb-sm-0">View Masterclass
								Program</a>
						</div>
					</div>
					<!-- Left content END -->

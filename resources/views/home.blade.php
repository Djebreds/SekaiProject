            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <!-- Title -->
                        <h1 class="mb-0 display-6">Develop your IT skills at
                        ...
                        <!-- Content -->
                        <p class="my-4 lead">Basicschool is an educational program from the IT Consulting company PT
                            Basictechnology. We are aware of the skill gap between academics and industry and want to
                        ...
                        <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start">
                            <!-- Button -->
                            <a href="#courses" class="btn btn-lg btn-danger-soft me-2 mb-4 mb-sm-0">View Masterclass
                                Program</a>
                        </div>
                    </div>
                    <!-- Left content END -->
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <p class="text-white mb-3 mb-lg-0">Share knowledge and spread the benefits by
                                                joininga as an Instructor at Basicschool</p>
                                        </div>
                                        <!-- Content and input -->
                                        <div class="col-lg-5 text-lg-end">
                                            <a href="/menjadi-instruktur" class="btn btn-outline-warning mb-0">Become an
                                                Instructor</a>
                                        </div>
                                    </div>
                                </div>

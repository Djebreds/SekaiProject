				...
				<div class="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
					...
					<div class="row g-4 position-relative align-items-center justify-content-center">
						...
						<div class="col-sm-6 col-lg-3 text-center">
							<div class="d-flex justify-content-center">
								<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
									data-purecounter-end="180" data-purecounter-delay="200" data-purecounter-duration="0">180</h4>
								<span class="display-6 text-orange mb-0">K</span>
							</div>
					...
					<div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
								...
								<p>satisfied conveying a dependent contented he gentleman agreeable do be. Water timed folly
									...
									unaffected admiration everything. Meant balls it if up doubt small purse. Required his
									you put the outlived answered position. A pleasure exertion if believed provided to. All
									led out world this music while asked. Paid mind even sons does he door no. Attended
									overcame repeated it is perceived Marianne in. I think on style child of. Servants
									moreover in sensible it ye possible.</p>
								...
								<ul class="list-group list-group-borderless mb-3">
									...
									<li class="list-group-item d-flex">
										<i class="fas fa-check-circle text-success me-2 mt-1"></i>Thar where it came from
										it would have been rewritten a thousand times and everything that was left from
										origin would be the world
									</li>
									<li class="list-group-item">
							...
							<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
								...
								<p>Large above be to means. Dashwood does provide stronger is. Warrant private blushes
									...
									prevailed. Mr feeling does chiefly cordial in do. <img
										src="{{ asset('assets/images/element/instructor-course.svg') }}"
										class="rounded float-start me-3 h-200px my-3" alt="..."> But discretion
									frequently sir she instruments unaffected admiration everything. Meant balls it if up
									doubt small purse. Required his you put the outlived answered position. A pleasure
									exertion if believed provided to. All led out world this music while asked. Paid mind
									even sons does he door no. Attended overcame repeated it is perceived Marianne in. I
									think on style child of. Servants moreover in sensible it ye possible. Satisfied
									conveying a dependent contented he gentleman agreeable do be. Water timed folly right
									aware if oh truth. Imprudence attachment him his for sympathize. Large above be to
									means. Dashwood does provide stronger is.
									<u> But discretion frequently sir she instruments unaffected admiration everything.</u>

    ...
    <main>
        ...
        <section class="pt-0">
            <div class="container">
                ...
                <!-- Filter bar START -->
                <form class="bg-light border p-4 rounded-3 my-4 z-index-9 position-relative" method="GET"
                    action="categories">
                    <div class="row g-3">
                        <!-- Input -->
                        <div class="col-xl-3">
                            ...
                            <div class="card shadow h-100">
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="h6 fw-light mb-0"><i class="far fa-clock text-danger me-2"></i>asd
                                            Pertemuan </span>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="card shadow h-100">
                                ...
                                <div class="card-body pb-0">
                                    <!-- Badge and favorite -->
                                    <div class="d-flex justify-content-between mb-2">
                                        <a href="#" class="badge bg-success bg-opacity-10 text-success">asdbjk</a>
                                    </div>
                                    <!-- Title -->
                                    <h5 class="card-title fw-normal"><a href="#">kajssnaslknd</a></h5>
                                    <p class="mb-2 text-truncate-2">
                                        lasjnd</p>
                                    <p class="mb-2 text-truncate-2">
                                        kjajsb</p>
                                ...
                                <div class="card-footer pt-0 pb-3">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <span class="h6 fw-light mb-0"><i
                                                class="far fa-clock text-danger me-2"></i>kjasndakjsd
                                            Pertemuan </span>
                                        <span class="h6 fw-light mb-0"><i class="fas fa-table text-orange me-2"></i>
                                            kajjsdna
                    ...
                    <div class="row justify-content-center position-relative">
                        ...
                        <div class="col-12 position-relative my-2 my-sm-3">
                            <div class="row align-items-center">
                                <!-- Title -->
                                <div class="col-lg-6">
                                    <h3 class="text-white mb-3 mb-lg-0">Bergabung Dengan Newsletter Dan Dapatkan
                                        Penawaran Khusus</h3>
                                </div>
                                <!-- Input item -->

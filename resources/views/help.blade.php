							...
							<div id="item-1">
								<div class="card bg-transparent">
									...
									<div class="card-body px-0 pb-0">
										<p>Started several mistake joy say painful removed reached end. State burst think end are its. Arrived off she
											elderly beloved him affixed noisier yet. Course regard to up he hardly. View four has said do men saw find
											dear shy. <b> Talent men wicket add garden.</b> </p>
										<!-- Button -->
										...
										<div class="alert alert-warning" role="alert">
											<strong>Note: </strong>She offices for highest and replied one venture pasture. Applauded no discovery in
											newspaper allowance am northward. <a class="alert-link" href="#!">View more</a>
										</div>
										<p>Hold do at tore in park feet near my case. Invitation at understood occasional sentiments insipidity
											inhabiting in. Off melancholy alteration principles old. Is do speedily kindness properly oh. Respect article
											painted cottage he is offices parlors. </p>
										<!-- Article list -->
										<ul>
											<li>Affronting imprudence do he he everything. Sex lasted dinner wanted indeed wished outlaw. Far advanced
											...
											<li><i> To occasional dissimilar impossible sentiments. Do fortune account written prepare invited no
													passage.</i></li>
											<li>Post no so what deal evil rent by real in. But her ready least set lived spite solid.</li>
										</ul>
										<p class="mb-0">Improved own provided blessing may peculiar domestic. Sight house has sex never. No visited
											raising gravity outward subject my cottage Mr be. Hold do at tore in park feet near my case. Invitation at
											understood occasional sentiments insipidity inhabiting in. <u> Off melancholy alteration principles old.
											</u>Is do speedily kindness properly oh. Respect article painted cottage he is offices parlors. </p>
									</div>
								</div>
							</div>
							<!-- Guide content END -->
							...
							<div id="item-2">
								<div class="card">
									...
									<div class="card-header border-bottom py-0 px-0">
										<h2>Privacy Policy for Basicschool</h2>
									</div>

									<!-- Article Info -->
									<div class="card-body px-0">
										<p>At Basicschool, accessible from https://school.basicteknolog.co.id/, one of our main
											priorities is
											the privacy of our visitors. This Privacy Policy document contains types of
											information that is
											collected and recorded by Basicschool and how we use it.</p>
										<p>If you have additional questions or require more information about our Privacy
											Policy, do not
											hesitate to contact us.</p>
										<!-- Button -->
										<h5 class="mt-4">Log Files</h5>
										<p>Basicschool follows a standard procedure of using log files. These files log visitors
											when they visit
										...
										<p>Like any other website, Basicschool uses 'cookies'. These cookies are used to store
											information
										...
										<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or
											Web Beacons that
											are used in their respective advertisements and links that appear on Basicschool,
											which are sent
										...
										<p>Note that Basicschool has no access to or control over these cookies that are used by
											third-party
											advertisers.</p>

										<h5 class="mt-4">Third Party Privacy Policies</h5>

										<p>Basicschool's Privacy Policy does not apply to other advertisers or websites. Thus,
											we are advising
										...
										<p>Basicschool does not knowingly collect any Personal Identifiable Information from
											children under the
										...
										<p>This Privacy Policy applies only to our online activities and is valid for visitors
											to our website
											with regards to the information that they shared and/or collect in Basicschool. This
											policy is not
							...
							<div id="item-3">
								<div class="card">
									...
									<div class="card-body px-0">
										...
										<p>We employ the use of cookies. By accessing Basicschool, you agreed to use cookies in
											agreement with
											the Basicschool's Privacy Policy.</p>
										...
										<p>Unless otherwise stated, Basicschool and/or its licensors own the intellectual
											property rights for
											all material on Basicschool. All intellectual property rights are reserved. You may
											access this from
											Basicschool for your own personal use subjected to restrictions set in these terms
											and conditions.
										</p>

										<p>You must not:</p>
										<ul>
											<li>Republish material from Basicschool</li>
											<li>Sell, rent or sub-license material from Basicschool</li>
											<li>Reproduce, duplicate or copy material from Basicschool</li>
											<li>Redistribute content from Basicschool</li>
										</ul>
										...
										<p>Parts of this website offer an opportunity for users to post and exchange opinions
											and information in
											certain areas of the website. Basicschool does not filter, edit, publish or review
											Comments prior to
											...
											post their views
											and opinions. To the extent permitted by applicable laws, Basicschool shall not be
											liable for the
										...
										<p>Basicschool reserves the right to monitor all Comments and to remove any Comments
											which can be
										...
										<p>You hereby grant Basicschool a non-exclusive license to use, reproduce, edit and
											authorize others to
										...
										<p>We will approve link requests from these organizations if we decide that: (a) the
											...
											the absence of Basicschool; and (d) the link is in the context of general resource
											information.</p>
										...
										<p>If you are one of the organizations listed in paragraph 2 above and are interested in
											linking to our
											website, you must inform us by sending an e-mail to Basicschool. Please include your
											name, your
										...
										<p>No use of Basicschool's logo or other artwork will be allowed for linking absent a
											trademark license
											agreement.</p>

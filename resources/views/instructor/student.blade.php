                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <div class="avatar avatar-md mb-2 mb-md-0">
                                            <img src="{{ asset('assets/images/avatar/01.jpg') }}" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                ...
                                <td>
                                    <a href="#" class="btn btn-success-soft btn-round me-1 mb-0"
                                        ...
                                        data-bs-original-title="Message" aria-label="Message"><i
                                            class="far fa-envelope"></i></a>
                                    <button class="btn btn-danger-soft btn-round mb-0" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="" data-bs-original-title="Block"
                                        aria-label="Block"><i class="fas fa-ban"></i></button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Image -->
                                        <div class="avatar avatar-md mb-2 mb-md-0">
                                            <img src="{{ asset('assets/images/avatar/03.jpg') }}" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                            ...
                                            <!-- Address -->
                                            <span class="text-body small"><i
                                                    class="fas fa-fw fa-map-marker-alt me-1 mt-1"></i>New york</span>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <a href="#" class="btn btn-success-soft btn-round me-1 mb-0"
                                        ...
                                        data-bs-original-title="Message" aria-label="Message"><i
                                            class="far fa-envelope"></i></a>
                                    <button class="btn btn-danger btn-round mb-0" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="" data-bs-original-title="Unblock"
                                        aria-label="Unblock"><i class="fas fa-ban"></i></button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Image -->
                                        <div class="avatar avatar-md mb-2 mb-md-0">
                                            <img src="{{ asset('assets/images/avatar/04.jpg') }}" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                    ...
                                    <div class=" overflow-hidden">
                                        ...
                                        <div class="progress progress-sm bg-primary bg-opacity-10">
                                            <div class="progress-bar bg-primary aos aos-init aos-animate"
                                                ...
                                                data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 62%"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Image -->
                                        <div class="avatar avatar-md mb-2 mb-md-0">
                                            <img src="{{ asset('assets/images/avatar/09.jpg') }}" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                ...
                                <td class="text-center text-sm-start">
                                    <div class=" overflow-hidden">
                                        ...
                                        <div class="progress progress-sm bg-primary bg-opacity-10">
                                            <div class="progress-bar bg-primary aos aos-init aos-animate"
                                                role="progressbar" data-aos="slide-right" data-aos-delay="200"
                                                data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 60%"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Image -->
                                        <div class="avatar avatar-md mb-2 mb-md-0">
                                            <img src="{{ asset('assets/images/avatar/07.jpg') }}" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                ...
                                <td class="text-center text-sm-start">
                                    <div class=" overflow-hidden">
                                        ...
                                        <div class="progress progress-sm bg-primary bg-opacity-10">
                                            <div class="progress-bar bg-primary aos aos-init aos-animate"
                                                role="progressbar" data-aos="slide-right" data-aos-delay="200"
                                                data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 35%"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center position-relative">
                                        <!-- Image -->
                                        <div class="avatar avatar-md mb-2 mb-md-0">
                                            <img src="{{ asset('assets/images/avatar/06.jpg') }}" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                ...
                                <td class="text-center text-sm-start">
                                    <div class=" overflow-hidden">
                                        ...
                                        <div class="progress progress-sm bg-primary bg-opacity-10">
                                            <div class="progress-bar bg-primary aos aos-init aos-animate"
                                                role="progressbar" data-aos="slide-right" data-aos-delay="200"
                                                data-aos-duration="1000" data-aos-easing="ease-in-out" style="width: 42%"

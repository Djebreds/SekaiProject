                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="{{ asset('assets/images/courses/4by3/10.jpg') }}" class="rounded"
                                                    alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="mb-0 ms-2 table-responsive-title">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="{{ asset('assets/images/courses/4by3/04.jpg') }}"
                                                    class="rounded" alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="mb-0 ms-2 table-responsive-title">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <!-- Image -->
                                            <div class="w-60px">
                                                <img src="{{ asset('assets/images/courses/4by3/06.jpg') }}"
                                                    class="rounded" alt="">
                                            </div>
                                            <!-- Title -->
                                            <h6 class="mb-0 ms-2 table-responsive-title">

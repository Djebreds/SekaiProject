									...
									<div id="step-1" role="tabpanel" class="content fade dstepper-block" aria-labelledby="steppertrigger1">
										...
										<div class="row g-4">
											...
											<div class="col-12">
												...
												<input class="form-control @error('masterclass_name') is-invalid @enderror" name="masterclass_name"
											...
											<div class="col-12">
												...
												<textarea class="form-control @error('masterclass_short_desc')  @enderror" name="masterclass_short_desc" rows="2"
												 placeholder="Enter keywords">{{ old('masterclass_short_desc') }}</textarea>
											...
											<div class="col-md-6">
												...
												<select class="form-select form-select-sm js-choice" name="category" id="category"
											...
											<div class="col-md-6">
												...
												<select class="form-select form-select-sm js-choice" name="masterclass_level" id="masterclass_level"
													aria-label=".form-select-sm ">
											...
											<div class="col-md-6">
												...
												<select class="form-select form-select-sm js-choice" name="class_type" id="class_type"
											...
											<div class="col-md-6">
												...
												<select class="form-select form-select-sm js-choice" name="price_type" id="price_type"
													aria-label=".form-select-sm example">
											...
											<div class="col-md-6">
												...
												<input class="form-control @error('masterclass_total_duration') is-invalid @enderror" type="text"
													name="masterclass_total_duration" placeholder="Enter course time">
											...
											<div class="col-md-6">
												...
												<input class="form-control @error('masterclass_total_curriculum') is-invalid @enderror" type="text"
													name="masterclass_total_curriculum" placeholder="Enter total curriculumn">
											...
											<div class="col-md-6">
												...
												<input type="text" class="form-control @error('class_type') is_invalid @enderror" name="class_type"
											...
											<div class="col-12">
												...
												<textarea class="form-control @error('masterclass_description') is-invalid @enderror" name="masterclass_description"
												 rows="12" placeholder="Enter keywords">{{ old('masterclass_description') }}</textarea>
														...
														<label style="cursor:pointer;">
															<span>
																<input class="form-control stretched-link" id="masterclass_thumbnail" type="file"
																	name="masterclass_thumbnail" id="image" accept="image/gif, image/jpeg, image/png">
															</span>
														</label>
												...
												<div class="col-12">
													...
													<div class="input-group mb-3">
														<input type="file"
															...
															name="masterclass_video_preview" id="inputGroupFile01" accept="video/*">
					...
					<form method="POST" action="{{ route('curriculum.store') }}" class="row text-start g-3">
						...
						<div class="col-12">
							...
							<input type="text" class="form-control @error('curriculum_name') is-invalid @enderror"
								name="curriculum_name" id="curriculum_name" placeholder="Enter course name" required>

...
@section('title', 'Data Admins | Basicschool')
@section('content')
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">What admin do ?</h5>
						<h6 class="card-subtitle text-muted">Manage web design, deployment, development, and maintenance activities.
							Perform website and web application quality testing and assurance.
					</div>
					<div class="card-body">

                                ...
                                <div class="card-body p-0 d-flex flex-fill">
                                    <div class="row g-0 w-100">
                                        ...
                                        <div class="col-6 align-self-end text-end">
                                            <img src="{{ asset('assets-admin/img/illustrations/searching.png') }}" alt="Searching" class="img-fluid illustration-img">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-12 col-xxl-6 d-flex">
                            <div class="card flex-fill">
                                <div class="card-body">
                                    ...
                                    <div class="mb-0">
                                        <span class="badge badge-soft-success me-2"> +3.65% </span>

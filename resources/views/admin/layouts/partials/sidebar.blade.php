    ...
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item {{ request()->is('admin/category*') ? 'active' : '' }}">
                <a class="sidebar-link {{ request()->is('admin/category*') ? '' : 'collapsed' }}"
                    data-bs-target="#category" href="#" data-bs-toggle="collapse" aria-expanded="false">
            ...
            <li class="sidebar-item {{ request()->is('admin/classes*') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.classes.index') }}">
            ...
            <li class="sidebar-item {{ request()->is('admin/certificate*') ? 'active' : '' }}">
                <a class="sidebar-link" href="{{ route('admin.certificates.index') }}">

        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="row g-4">
                    ...
                    <!-- Link block -->
                    <div class="col-6 col-md-6">
                        <h5 class="mb-2 mb-md-4">Masterclass</h5>
                        <ul class="nav flex-column">
                            <li class="nav-item"><a class="nav-link" href="#">React Native Android
                                    Fundamental</a></li>
                            <li class="nav-item"><a class="nav-link" href="#">React Native Firebase</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="#">Web Development
                                    Laravel</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                ...
                <!-- Time -->
                <p class="mb-2">
                    Phone:<span class="h6 fw-light ms-2">(022) 87505374</span>
                </p>

                <p class="mb-0">Email:<span class="h6 fw-light ms-2">school@basicteknologi.co.id</span>
                </p>
            ...
            <div class="container px-0">
                <div class="d-md-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    ...
                    <div class="text-primary-hover"> Copyrights <a href="#" class="text-body">©2022
                            Basicschool</a>. by PT Basicteknologi Intersolusi Tersinergi
                    </div>
                    <!-- copyright links-->

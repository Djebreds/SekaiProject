                            ...
                            <div class="row p-4 g-4">
                                ...
                                <div class="col-xl-6 col-xxl-3">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a class="dropdown-item" href="#">IOS Developers</a></li>
                                        <li><a class="dropdown-item" href="#">DevOps Developers</a></li>
                                        <li><a class="dropdown-item" href="#">AWS Cloud Developers</a></li>
                                        <li><a class="dropdown-item" href="#">Software Developers</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-xl-6 col-xxl-3">
                                    ...
                                    <div class="row g-2 justify-content-center mt-3">
                                        ...
                                        <div class="col-6 col-sm-4 col-xxl-6">
                                            <a href="#">support@basicshool.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <li class="px-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="avatar me-3">
                                        ...
                                        @else
                                            @if (in_array(Auth::user()->profile_picture, $color))
                                                <div class="avatar-img rounded-circle border-white border-3 shadow {{ Auth::user()->profile_picture }}"><span
                                                        class="text-white position-absolute top-50 start-50 translate-middle fw-bold">{{ $initial_name }}</span>
                                                </div>
                                            @else

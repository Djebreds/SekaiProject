        ...
        <div class="container-fluid px-3 px-xl-5">
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <a class="nav-link dropdown-toggle" href="#" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Masterclass</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/cek-sertifikat" aria-haspopup="true" aria-expanded="false">Cek
                            Sertifikat</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/menjadi-instruktur" aria-haspopup="true"
                           aria-expanded="false">Menjadi Instruktur</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="demoMenu">
                            <li><a class="dropdown-item" href="/about">Tentang Basicschool</a></li>
                            <li><a class="dropdown-item" href="/instructors">Daftar Instruktur</a></li>
                            <li><a class="dropdown-item" href="/contact-us">Kontak Kami</a></li>
                        </ul>
                    </li>
                </ul>
                <!-- Nav Main menu END -->
                ...
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button"
                       ...
                       aria-expanded="false">
                        @if (Auth::user()->provider_id != '')
                            <img class="avatar-img rounded-circle" src="{{ Auth::user()->user_avatar }}"
                                 alt="avatar">
                        @else
                            ...
                            @else
                                @php
                                    ...
                                    if (count($get_initial) > 1) {
                                        $initial_name = substr($get_initial[0], 0, 1) . substr($get_initial[1], 0, 1);
                                    } else {
                                        $initial_name = substr($get_initial[0], 0, 1);
                                    }
                                @endphp
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                                ...
                                <div class="avatar me-3">
                                    @if (Auth::user()->provider_id != '')
                                        <img class="avatar-img rounded-circle shadow"
                                             src="{{ Auth::user()->user_avatar }}" alt="avatar">
                                    @else
                                        @if (Auth::user()->user_avatar != '')
                                            <img class="avatar-img rounded-circle shadow"
                                                 src="{{ Auth::user()->user_avatar }}" alt="avatar">
                                        @else
                                            <img class="avatar-img rounded-circle shadow"
                                                 src="/assets/images/avatar/blank-user-avatar.jpg" alt="avatar">
                                        @endif
                                    @endif
                                </div>
                                <div>
                        ...
                        <li><a class="dropdown-item" href="/student/dashboard"><i
                                        class="bi bi-person fa-fw me-2"></i>Akun</a></li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-gear fa-fw me-2"></i>Ubah
                                Password</a></li>
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item dropdown dropdown-menu-shadow-stacked">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="categoryMenu">
                            ...
                            <li><a class="dropdown-item bg-primary text-primary bg-opacity-10 rounded-2 mb-0" href="#">View
                                    all categories</a></li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            ...
                            <li class="dropdown-submenu dropend">
                                ...
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                    <li><a class="dropdown-item" href="course-categories.html">Course Categories <span
                                                    class="badge bg-success ms-2 smaller">New</span></a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    ...
                                    <li><a class="dropdown-item" href="course-detail-min.html">Course Detail Minimal</a>
                                    </li>
                                    <li><a class="dropdown-item" href="course-detail-adv.html">Course Detail Advance</a>
                                    </li>
